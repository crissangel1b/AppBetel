...
<html>
    ...
    <body class="fixed_header left_nav_fixed atm-spmenu-push dark_theme blue_thm" style="background: #f1f1f1;">
      ...
      <div class="btn-group pull-right">
          <button href="javascript:void(0);" data-toggle="modal" data-target="#myModal3" class="btn btn-info" title="Editar Producto" onclick="obtener_datos('1129');" ><i class="glyphicon glyphicon-edit"></i></a> </button>
      </div>
